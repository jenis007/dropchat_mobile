  ...
  factory AuthSignupModel.fromJson(Map<String, dynamic> json) {
    return AuthSignupModel(
      ...
      data: json != null
          ...
          : null, // Use the root json object for UserData
...
class UserData {
  ...
  factory UserData.fromJson(Map<String, dynamic> json) {
    return UserData(
      area: json['area'],
      token: json['token'],
      isLogin: json['registration_status'],
      avatar: json['avatar'],
      avatarThumbnail: json['avatar_thumbnail'],
      badges: json['badges'] ?? [],
      bio: json['bio'],
      ...
      dateJoined: json['date_joined'],
      email: json['email'],
      enablePushNotifications: json['enable_push_notifications'] is String
      ...
      lastOnlineAt: json['last_online_at'],
      phone: json['phone'],
      preferedRadius: json['prefered_radius'] is String
          ? num.tryParse(json['prefered_radius']) ?? 0
          : json['prefered_radius'] ?? 0,
      reactions: json['reactions'] != null
          ? Reactions.fromJson(json['reactions'])
          : null,
      referralCode: json['referral_code'],
      ...
      userTags: json['user_tags'] ?? [],
      username: json['username'],
      verifiedPhone: json['verified_phone'] is String
          ? json['verified_phone'] == 'true'
          : json['verified_phone'] ?? false,
    );
  }
