  ...
  Widget build(BuildContext context) {
    ...
    Widget check = Container(
      ...
      decoration: BoxDecoration(
        color: widget.successColor ?? const Color(0xFF0D65D9),
        borderRadius:
    ...
    final btn = Container(
      decoration: ShapeDecoration(
        ...
        //         colors: [Color(0xFFB85CFE), Color(0xFF740EC0)]),
        shape: widget.shape ??
            RoundedRectangleBorder(
                borderRadius:
                    widget.borderRadiusGeometry ?? BorderRadius.circular(50),
                side: widget.side ?? BorderSide.none),
        shadows: widget.shadows ??
            [
              BoxShadow(
                color: widget.shadowsColor ??
                    const Color(0xFF0D65D9).withOpacity(0.4),
                blurRadius: widget.blurRadius ?? 4,
